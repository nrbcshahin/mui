...
import NewDpdcBill from "./modules/ElectricityBill/DpdcPostpaid/NewDpdcBill";
...
import DpdcBillDetails from "./modules/ElectricityBill/DpdcPostpaid/DpdcBillDetails";
      ...
      <Router>
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path="/electricity-bill/dpdc-postpaid/new-bill" element={<NewDpdcBill />} />
            <Route path="/electricity-bill/dpdc-postpaid/bill-details" element={<DpdcBillDetails />} />
